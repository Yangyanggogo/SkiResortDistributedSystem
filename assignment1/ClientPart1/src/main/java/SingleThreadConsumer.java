...
public class SingleThreadConsumer {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    ConsumerSingle singleConsumer = new ConsumerSingle(countRequest,ipAddress,true,eventQueue,cntSuccessPosts,cntFailPosts,latch);
    ...
    System.out.println("Response Time: "+((double)(wallTime)/(cntSuccessPosts.get()+cntFailPosts.get())) + " ms/request");
